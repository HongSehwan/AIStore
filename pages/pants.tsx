...
const PantsPage: React.FC<PantsPageProps> = () => {
    const [pantsItem, setPantsItem] = useState<ClothingItem[]>([]);
    ...
    useEffect(() => {
        let pants = storeItem.filter((item) => item.type === "pants");
        setPantsItem(pants);
    }, []);

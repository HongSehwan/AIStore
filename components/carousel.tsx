...
const Carousel: React.FC = () => {
    ...
    return (
        <div className="sliderWrapper">
            <ul className="slider">
                <li className="sliderItem bg-[url('/images/main-slider-image1.jpeg')]">
                ...
                <li className="sliderItem bg-[url('/images/main-slider-image2.jpeg')]">
                    <div className="sliderContent">
                ...
                <li className="sliderItem bg-[url('/images/main-slider-image3.jpeg')]">
                    <div className="sliderContent">
                ...
                <li className="sliderItem bg-[url('/images/main-slider-image4.jpeg')]">
                    <div className="sliderContent">
                ...
                <li className="sliderItem bg-[url('/images/main-slider-image5.jpeg')]">
                    <div className="sliderContent">
                ...
                <li className="sliderItem bg-[url('/images/main-slider-image6.jpeg')]">
                    <div className="sliderContent">
                ...
                <li className="sliderItem bg-[url('/images/main-slider-image7.jpeg')]">
                    <div className="sliderContent">
